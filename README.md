...
All Zapier CLI apps are run using Node.js `v4.3.2 or v6.10.2`.

You can develop using any version of Node you'd like, but your code has to run on Node `v4.3.2 or v6.10.2`. You can accomplish this by developing on your preferred version and then transpiling with [Babel](https://babeljs.io/) (or similar).

To ensure stability for our users, we also require that you run your tests on `v4.3.2 or v6.10.2` as well. If you don't have it available, we recommend using either [nvm](https://github.com/creationix/nvm#installation) or [n](https://github.com/tj/n#installation) to install `v4.3.2 or v6.10.2` and run the tests locally. On Windows you can use [nvm-windows](https://github.com/coreybutler/nvm-windows#installation--upgrades) or [nodist](https://github.com/marcelklehr/nodist#installation).
